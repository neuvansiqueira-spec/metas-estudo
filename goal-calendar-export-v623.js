/* V623.1 — Calendário de Metas: exportações legíveis, timbre Aldus, Fábrica real e vínculo meta↔produto. */
(() => {
  "use strict";

  const VERSION = "20260915-calendario-exportacoes-v623-1";
  ...
  function goalState(goal, report) {
    ...
    if (factoryEvidenceForGoal(goal, report).length) return "factory";
...
#goalCalendarPrintableReport.aldus-cal-v623{color:${COLORS.ink}!important;font:9pt/1.42 Arial,Helvetica,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact;opacity:1!important}.aldus-cal-v623 *{box-sizing:border-box;opacity:1!important}.aldus-cal-v623 .acv-sheet{width:100%;border-collapse:collapse}.aldus-cal-v623 .acv-sheet>thead>tr>td,.aldus-cal-v623 .acv-sheet>tbody>tr>td,.aldus-cal-v623 .acv-sheet>tfoot>tr>td{padding:0;border:0;background:none}.aldus-cal-v623 .acv-letterhead{display:flex;align-items:center;gap:4mm;padding:0 0 2.6mm;margin:0 0 4mm;border-bottom:.7mm solid ${COLORS.navy};box-shadow:0 .8mm 0 ${COLORS.gold}}.aldus-cal-v623 .acv-logo{width:38mm;flex:0 0 38mm;line-height:0}.aldus-cal-v623 .acv-logo svg{display:block;width:100%;height:auto}.aldus-cal-v623 .acv-doc{margin-left:auto;text-align:right}.aldus-cal-v623 .acv-doc strong{display:block;color:${COLORS.navy}!important;font-size:11pt}.aldus-cal-v623 .acv-doc span{color:${COLORS.muted}!important;font-size:8pt}.aldus-cal-v623 .acv-cover{margin:0 0 5mm;padding:5mm 6mm;border-radius:3mm;color:#fff!important;background:linear-gradient(120deg,${COLORS.navy},#0B3A7A 62%,${COLORS.blue})}.aldus-cal-v623 .acv-cover *{color:#fff!important}.aldus-cal-v623 .acv-cover p{margin:0;font-size:7.5pt;font-weight:700;letter-spacing:.18em}.aldus-cal-v623 .acv-cover h1{margin:1.2mm 0 1.6mm;font-size:19pt;line-height:1.1}.aldus-cal-v623 .acv-section{margin:0 0 6mm}.aldus-cal-v623 .acv-section-title{display:flex;justify-content:space-between;align-items:baseline;gap:4mm;margin:0 0 3mm;padding:2.4mm 3.5mm;border-radius:2mm;background:${COLORS.blueSoft};border-left:1.6mm solid ${COLORS.blue};break-after:avoid}.aldus-cal-v623 .acv-section-title h2{margin:0;color:${COLORS.navy}!important;font-size:12pt}.aldus-cal-v623 .acv-section-title span{color:${COLORS.muted}!important;font-size:8pt;white-space:nowrap}.aldus-cal-v623 .acv-factory .acv-section-title{background:${COLORS.goldSoft};border-left-color:${COLORS.gold}}.aldus-cal-v623 .acv-kpis{display:grid;grid-template-columns:repeat(5,1fr);gap:2.4mm;margin:0 0 2.4mm;break-inside:avoid}.aldus-cal-v623 .acv-kpi{padding:2.2mm 3mm;border:.25mm solid ${COLORS.line};border-radius:2mm;background:${COLORS.paper}}.aldus-cal-v623 .acv-kpi span{display:block;color:${COLORS.muted}!important;font-size:7pt;text-transform:uppercase;letter-spacing:.04em}.aldus-cal-v623 .acv-kpi strong{display:block;color:${COLORS.navy}!important;font-size:13pt}.aldus-cal-v623 .acv-progress{height:1.8mm;border-radius:1mm;background:#E2E8F0;overflow:hidden;margin:0 0 3mm}.aldus-cal-v623 .acv-progress i{display:block;height:100%;background:${COLORS.green}}.aldus-cal-v623 .acv-chips{margin:0 0 3mm;color:${COLORS.muted}!important;font-size:7.8pt}.aldus-cal-v623 .acv-chips b{display:inline-block;margin:0 1mm 1mm 0;padding:.6mm 2mm;border-radius:3mm;background:#EEF2F8;color:${COLORS.ink}!important}.aldus-cal-v623 table{min-width:0!important}.aldus-cal-v623 table.acv-goals{width:100%;border-collapse:collapse;font-size:8.3pt;table-layout:fixed}.aldus-cal-v623 table.acv-goals th{padding:1.8mm 2mm;background:${COLORS.navy};color:#fff!important;text-align:left;font-size:7.3pt}.aldus-cal-v623 table.acv-goals td{padding:1.8mm 2mm;border-bottom:.25mm solid ${COLORS.line};vertical-align:top;color:${COLORS.ink}!important}.aldus-cal-v623 table.acv-goals tbody tr:nth-child(even) td{background:${COLORS.paper}}.aldus-cal-v623 table.acv-goals tr{break-inside:avoid}.aldus-cal-v623 .acv-subject strong{display:block;color:${COLORS.navy}!important}.aldus-cal-v623 .acv-pill{display:inline-block;padding:.5mm 2mm;border-radius:3mm;font-size:7pt;font-weight:700;white-space:normal}.aldus-cal-v623 .acv-pill.done,.aldus-cal-v623 .acv-pill.factory{background:${COLORS.greenSoft};color:${COLORS.green}!important}.aldus-cal-v623 .acv-pill.missed{background:${COLORS.redSoft};color:${COLORS.red}!important}.aldus-cal-v623 .acv-pill.pending{background:${COLORS.blueSoft};color:${COLORS.blue}!important}.aldus-cal-v623 .acv-day{margin:0 0 2.6mm;border:.25mm solid ${COLORS.line};border-radius:2mm;overflow:hidden;break-inside:avoid}.aldus-cal-v623 .acv-day-head{display:flex;justify-content:space-between;gap:3mm;padding:1.8mm 3mm;background:${COLORS.paper};border-bottom:.25mm solid ${COLORS.line};color:${COLORS.ink}!important}.aldus-cal-v623 .acv-day-head strong{color:${COLORS.navy}!important}.aldus-cal-v623 .acv-day ul{list-style:none;margin:0;padding:1.2mm 3mm}.aldus-cal-v623 .acv-day li{display:flex;justify-content:space-between;gap:3mm;padding:.9mm 0;border-bottom:.2mm dashed #E2E8F0;color:${COLORS.ink}!important}.aldus-cal-v623 .acv-empty,.aldus-cal-v623 .acv-note{color:${COLORS.muted}!important;font-style:italic}.aldus-cal-v623 .acv-note{margin:-1mm 0 3mm;font-size:7.8pt}.aldus-cal-v623 .acv-record{margin:0 0 2.8mm;border:.25mm solid ${COLORS.line};border-left:1.4mm solid ${COLORS.gold};border-radius:2mm;overflow:hidden;break-inside:avoid;background:#fff}.aldus-cal-v623 .acv-record dl{display:grid;grid-template-columns:49mm 1fr;margin:0}.aldus-cal-v623 .acv-record dt,.aldus-cal-v623 .acv-record dd{margin:0;padding:1.2mm 3mm;border-top:.2mm solid #E5E7EB}.aldus-cal-v623 .acv-record dt{color:#334155!important;font-size:7.2pt;font-weight:800;letter-spacing:.02em}.aldus-cal-v623 .acv-record dd{color:${COLORS.ink}!important;font-size:8.6pt;font-weight:500;word-break:break-word}.aldus-cal-v623 .acv-record dd.statement{grid-column:1/-1;color:${COLORS.blue}!important;font-weight:800;background:#F1F5F9}.aldus-cal-v623 .acv-record dd.warn{color:${COLORS.amber}!important;font-weight:800}.aldus-cal-v623 .acv-record a{color:${COLORS.blue}!important;text-decoration:underline;font-weight:600}.aldus-cal-v623 .acv-footer{margin-top:3mm;padding-top:2mm;border-top:.25mm solid ${COLORS.line};color:${COLORS.muted}!important;font-size:7.3pt;display:flex;justify-content:space-between}`; }
  ...
  function factoryHtml(title, entries, empty, report) { return `<section class="acv-section acv-factory"><div class="acv-section-title"><h2>${esc(title)}</h2><span>${entries.length} registro(s)</span></div><p class="acv-note">${esc(report.driveNote)}.</p>${entries.length?entries.map(recordHtml).join(""):`<p class="acv-empty">${esc(empty)}</p>`}</section>`; }
  function buildPrintHtml(report) {
    ...
    return `<article id="goalCalendarPrintableReport" class="aldus-cal-v623" data-version="${VERSION}"><style>${printCss()}</style><table class="acv-sheet"><thead><tr><td>${letterheadHtml(report)}</td></tr></thead><tbody><tr><td>${content}</td></tr></tbody><tfoot><tr><td><div class="acv-footer"><span>Aldus Meta · Metas de Estudo</span><span>Gerado em ${esc(dateTimeBR(report.generatedAt))}</span></div></td></tr></tfoot></table></article>`;
  }
  ...
  function buildSvg(report) {
    ...
    for(const period of report.periods){section(period.title,periodRange(period.data));const m=periodMetrics(period.data,report),tiles=[["Metas",m.goals],["Concl./prod.",m.recognized],["Cumprimento",`${m.percent}%`],["Planejado",minutesLabel(m.planned)],["Realizado",minutesLabel(m.actual)]],tw=(CW-64)/5;tiles.forEach(([l,v],i)=>{const x=M+i*(tw+16);p.push(`<rect x="${x}" y="${y}" width="${tw}" height="84" rx="12" fill="${COLORS.paper}" stroke="${COLORS.line}"/>`);p.push(svgText(x+18,y+30,l.toUpperCase(),{size:13,weight:700,color:COLORS.muted,maxWidth:tw-30}));p.push(svgText(x+18,y+67,v,{size:28,weight:800,color:COLORS.navy,maxWidth:tw-30}));});y+=100;p.push(`<rect x="${M}" y="${y}" width="${CW}" height="9" rx="5" fill="#E2E8F0"/><rect x="${M}" y="${y}" width="${Math.round(CW*m.percent/100)}" height="9" rx="5" fill="${COLORS.green}"/>`);y+=28;for(const day of period.data.days||[]){if(period.key!=="daily"){p.push(`<rect x="${M}" y="${y}" width="${CW}" height="42" rx="9" fill="${COLORS.paper}" stroke="${COLORS.line}"/>`);p.push(svgText(M+18,y+28,`${weekdayOf(day.date)} · ${dateBR(day.date)} · ${day.dayType}`,{size:17,weight:800,color:COLORS.navy}));y+=50;}for(const g of day.goals||[]){const s=goalState(g,report),[strong,soft]=STATE_COLORS[s];p.push(`<rect x="${M}" y="${y}" width="${CW}" height="58" rx="10" fill="#fff" stroke="${COLORS.line}"/><rect x="${M}" y="${y}" width="8" height="58" rx="4" fill="${strong}"/>`);p.push(svgText(M+24,y+25,`${g.discipline} — ${g.subject}`,{size:17,weight:700,color:COLORS.navy,maxWidth:CW-260}));p.push(svgText(M+24,y+46,`${g.type} · ${minutesLabel(g.plannedMinutes)} planejado · ${minutesLabel(g.actualMinutes)} realizado`,{size:13,color:COLORS.muted,maxWidth:CW-260}));p.push(`<rect x="${W-M-210}" y="${y+14}" width="190" height="29" rx="15" fill="${soft}"/>`);p.push(svgText(W-M-115,y+34,STATE_LABEL[s],{size:13,weight:800,color:strong,anchor:"middle",maxWidth:175}));y+=65;}if(!(day.goals||[]).length){p.push(svgText(M+18,y+22,"Sem metas.",{size:14,color:COLORS.muted}));y+=34;}}y+=12;}
  ...
  function calendarSheet(report){const cols=11,rows=letterheadRows("Calendário de metas",`Referência ${dateBR(report.referenceDate)} · ${report.scopeLabel} · ${dateTimeBR(report.generatedAt)}`,cols,3),merges=[];for(const period of report.periods){const start=rows.length+1;rows.push({height:26,cells:[{v:`${period.title.toUpperCase()} — ${periodRange(period.data)}`,s:XS.section},...Array.from({length:cols-1},()=>({v:"",s:XS.section}))]});merges.push(`A${start}:${columnName(cols)}${start}`);const m=periodMetrics(period.data,report),k=[["Metas",m.goals],["Concl./produzidas",m.recognized],["Cumprimento",`${m.percent}%`],["Planejado",minutesLabel(m.planned)],["Realizado",minutesLabel(m.actual)]];rows.push({cells:k.flatMap(([l])=>[{v:l,s:XS.kpiLabel},{v:"",s:XS.kpiLabel}]).concat([{v:"",s:XS.kpiLabel}])});rows.push({height:24,cells:k.flatMap(([,v])=>[{v:v,s:XS.kpiValue},{v:"",s:XS.kpiValue}]).concat([{v:"",s:XS.kpiValue}])});rows.push({height:32,cells:["Data","Dia","Tipo do dia","Disciplina","Assunto","Tipo","Planejado (min)","Realizado (min)","Situação","Evidência na Fábrica","Prioridade"].map((v)=>({v,s:XS.header}))});let zebra=false;for(const day of period.data.days||[]){const goals=day.goals.length?day.goals:[null];for(const g of goals){const base=zebra?XS.zebra:XS.cell,num=zebra?XS.numberZebra:XS.number;if(!g){rows.push({cells:[{v:dateBR(day.date),s:base},{v:weekdayOf(day.date),s:base},{v:day.dayType,s:base},{v:"Sem metas",s:base},...Array.from({length:7},()=>({v:"",s:base}))]});continue;}const st=goalState(g,report),evidence=factoryEvidenceForGoal(g,report).map((x)=>x.kind==="resumo"?`Resumo ${x.record.typeLabel} — ${x.record.factoryStatus}`:`Treino ${x.record.typeLabel}`).join(" | ");rows.push({cells:[{v:dateBR(day.date),s:base},{v:weekdayOf(day.date),s:base},{v:day.dayType,s:base},{v:g.discipline,s:base},{v:g.subject,s:base},{v:g.type,s:base},{v:Number(g.plannedMinutes)||0,s:num},{v:Number(g.actualMinutes)||0,s:num},{v:STATE_LABEL[st],s:XS[st]},{v:evidence||"—",s:base},{v:g.priority,s:base}]});}zebra=!zebra;}rows.push(null);}return{name:"Calendário",cols:[12,7,16,26,42,14,13,13,18,38,12],rows,merges,freezeRow:5};}
  ...
  const api=Object.freeze({VERSION,PREJUDICADO,NO_DATE,DRIVE_NOTES,PRODUCED_STATUSES,elaboratedSummaries,trainingRecords,editalInfo,driveIdFrom,fileKind,pickModuleFiles,createDriveReader,summaryView,trainingView,buildReport,buildPrintHtml,buildSvg,buildWorkbookFiles,runExport});
  globalThis[FLAG]=api;
