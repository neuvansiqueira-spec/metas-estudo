...
function synchronizeBootstrapFastPathFallback() {
  const filePath = path.join(root, "bootstrap-fast-path-v351.js");
  const source = fs.readFileSync(filePath, "utf8");
  const synchronized = source.replace(
    /const FALLBACK_APPLICATION_SCRIPT = "app-v\d+\.js\?v=[^"]+";/,
    `const FALLBACK_APPLICATION_SCRIPT = "app-${releaseSuffix}.js?v=${packageVersion}";`
  );
  if (!synchronized.includes(`const FALLBACK_APPLICATION_SCRIPT = "app-${releaseSuffix}.js?v=${packageVersion}";`)) {
    throw new Error("Não foi possível sincronizar o fallback do bundle no fast path.");
  }
  fs.writeFileSync(filePath, synchronized);
}
...
synchronizeBootstrapFastPathFallback();
...
const jsSources = [
  ...
  "exam-tracker-core.js",
  "exam-tracker-card.js",
  "exam-tracker-factory.js",
...
for (const filename of [
  ...
  "question-training.js", "question-training-card.js", "question-training-ui.js", "daily-plan-question-import-v451.js", "performance-emergency-v350.js", "performance-hot-paths-v622.js", "goal-calendar-export-v623.js",
  ...
  "bootstrap-fast-path-v351.js", "bootstrap-integrity-loader-v258.js", "bootstrap-integrity-loader-v258-core.js", "bootstrap-integrity-loader-v275.js",
  "startup-planning-stability-v387.js", "service-worker-v378.js", "service-worker-v402.js",
