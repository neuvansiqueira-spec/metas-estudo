(() => {
  ...
  const VERSION = "20260921-factory-densidade-completude-v327";
  const MIGRATION_ID = "factoryResumoAulaCanonicalVisualV327";
  const CONTENT_MIGRATION_ID = "factoryResumoDensidadeCompletude20260921";
  const CONTENT_HEADING = "## AUTOSSUFICIÊNCIA DO CONTEÚDO E RESOLUÇÃO DE REMISSÕES";
  // V635 (21/09): a política de 11/09 ("PRECISÃO E CONCISÃO") autorizava omitir conteúdo
  // (menor redação suficiente, detalhes acessórios, não responder a toda pergunta). Fica só
  // a regra contra repetição; o padrão passa a ser densidade + completude.
  const REVISION_20260911 = "APLICAÇÃO TRANSVERSAL A TODAS AS DISCIPLINAS — PRECISÃO E CONCISÃO";
  const CONTENT_REVISION = "APLICAÇÃO TRANSVERSAL A TODAS AS DISCIPLINAS — DENSIDADE E COMPLETUDE, SEM REPETIÇÃO";
  const CONTENT_END = "FIM DAS REGRAS DE AUTOSSUFICIÊNCIA.";
  const CONTENT_TYPES = ["resumoAulaJurisprudencia", "consolidacao"];
  const FULL_RECOVERY_RULE = "RECUPERE INTEGRALMENTE NAS FONTES AUTORIZADAS AS INFORMAÇÕES PERTINENTES AO RECORTE, INCLUSIVE EXCEÇÕES, DISTINÇÕES, DIVERGÊNCIAS, HIPÓTESES ESPECÍFICAS, JURISPRUDÊNCIA, ATUALIZAÇÕES E PONTOS DE PROVA, PRESERVANDO A FORMATAÇÃO E SEM REPETIÇÃO.";
  const CONTENT_SECTION = `${CONTENT_HEADING}

${CONTENT_REVISION}

PADRÃO OBRIGATÓRIO: DENSIDADE + COMPLETUDE, SEM REPETIÇÃO — NÃO BREVIDADE. COMPLETUDE SIGNIFICA COBERTURA INTEGRAL DO RECORTE: TODO INSTITUTO, SUBTEMA, REGRA, EXCEÇÃO, DISTINÇÃO, DIVERGÊNCIA, HIPÓTESE ESPECÍFICA, JURISPRUDÊNCIA, ATUALIZAÇÃO E PONTO DE PROVA PRESENTE NAS FONTES AUTORIZADAS DEVE CONSTAR DA SAÍDA, DESENVOLVIDO NA EXTENSÃO NECESSÁRIA PARA SER COMPREENDIDO E RESPONDIDO EM PROVA. DENSIDADE SIGNIFICA ELIMINAR REPETIÇÃO, REDUNDÂNCIA E FRASES DE PREENCHIMENTO; NUNCA SIGNIFICA ELIMINAR CONTEÚDO. EXCEÇÕES, DISTINÇÕES, DIVERGÊNCIAS, JURISPRUDÊNCIA, ATUALIZAÇÕES, HIPÓTESES ESPECÍFICAS E PONTOS DE PROVA NÃO SÃO CONTEÚDO ACESSÓRIO E NÃO PODEM SER OMITIDOS PARA ENCURTAR O RESUMO. O TAMANHO DO RESUMO É CONSEQUÊNCIA DA COBERTURA: NÃO HÁ META DE BREVIDADE NEM LIMITE DE EXTENSÃO. PRESERVE A ESTRUTURA, A HIERARQUIA, A FORMATAÇÃO E O ESTILO TOPIFICADO DO MÓDULO; ESTAS REGRAS NÃO TRANSFORMAM O RESUMO EM TEXTO CORRIDO.
...
7. DUPLICAÇÃO REAL. COMPARE O SENTIDO, NÃO APENAS AS PALAVRAS. QUANDO DOIS TRECHOS TRANSMITIREM A MESMA INFORMAÇÃO, COM O MESMO ALCANCE E FUNÇÃO, CONSOLIDE-OS NO LOCAL MAIS ADEQUADO. AO CONSOLIDAR, PRESERVE SEMPRE QUALQUER CONDIÇÃO, EXCEÇÃO, DISTINÇÃO OU DETALHE ÚNICO PERTINENTE AO RECORTE: SÓ SE ELIMINA A REPETIÇÃO DA MESMA INFORMAÇÃO. NÃO CONFUNDA CONTRADIÇÃO, DIFERENÇA DE HIPÓTESE OU COMPLEMENTO COM DUPLICAÇÃO. NÃO REPITA A MESMA FRASE SOB RÓTULOS COMO CONCEITO, REGRA, EFEITO E PROVA SEM ACRESCENTAR FUNÇÃO DIDÁTICA.
...
9. SEM REPETIÇÃO E SEM FRAGMENTAÇÃO. NÃO HÁ META NUMÉRICA DE PALAVRAS POR LINHA NEM LIMITE DE TAMANHO DO RESUMO. USE SUBITENS PRÓPRIOS SEMPRE QUE HOUVER CONDIÇÃO, REQUISITO, EXCEÇÃO, ETAPA, PRAZO OU DIFERENÇA DE HIPÓTESE; AGRUPE EM UMA LINHA SOMENTE ENUMERAÇÕES SIMPLES DE ITENS SEM REGIME PRÓPRIO. RETIRE FRASES DE PREENCHIMENTO E EXEMPLOS QUE APENAS REPITAM A REGRA. SUMÁRIO E QUADRO FINAL, QUANDO EXIGIDOS, MANTÊM SUA FUNÇÃO DE NAVEGAÇÃO E REVISÃO, SEM REPRODUÇÃO INTEGRAL DOS BLOCOS.
10. COBERTURA DAS FONTES E DOS PRODUTOS. INVENTARIE INTERNAMENTE AS UNIDADES DE CONTEÚDO RELEVANTES AO RECORTE AUTORIZADO E CONFIRA SUA PRESENÇA NA SAÍDA. OMITA SOMENTE O QUE FOR ALHEIO AO RECORTE. TODA UNIDADE PERTINENTE AO RECORTE DEVE CONSTAR DA SAÍDA: NÃO TRANSCREVA AS FONTES, MAS NÃO OMITA CONTEÚDO PERTINENTE, AINDA QUE PAREÇA DETALHE. SE A CONFERÊNCIA REVELAR LACUNA, ACRESCENTE O CONTEÚDO FALTANTE, AINDA QUE ISSO AUMENTE O RESUMO. QUANDO HOUVER JURISPRUDÊNCIA, COMPARE TESE POR TESE, COM HIPÓTESE, ALCANCE, DISTINÇÕES E IDENTIFICAÇÃO DISPONÍVEIS NA FONTE. UM MESMO JULGADO PODE CONTER TESES DIFERENTES; JULGADOS DIFERENTES PODEM REPETIR A MESMA TESE. AGRUPE EQUIVALÊNCIAS SEM APAGAR CONTRIBUIÇÕES ÚNICAS, DIVERGÊNCIAS OU EVOLUÇÃO. NÃO FORCE JURISPRUDÊNCIA NO MÓDULO PURO NEM EM DISCIPLINA SEM ESSA CAMADA.
11. CONFERÊNCIA EFETIVA ANTES DA ENTREGA. COMPARE O TEXTO FINAL COM AS FONTES, ESPECIALMENTE APÓS AGRUPAR OU CONSOLIDAR. CONFIRA DADOS, HIPÓTESES, RÓIS, CONDIÇÕES, VERBOS E COBERTURA. VERIFIQUE SE FALTA ALGUM ELEMENTO NECESSÁRIO PARA ENTENDER A AFIRMAÇÃO, SE AS QUESTÕES RELEVANTES DO TEMA PARA PROVA — REGRA, EXCEÇÃO, DISTINÇÃO, DIVERGÊNCIA, JURISPRUDÊNCIA E ATUALIZAÇÃO — ESTÃO RESPONDIDAS QUANDO AS FONTES AS TRAZEM, E SE CADA REPETIÇÃO É REALMENTE NECESSÁRIA. CORRIJA AS FALHAS IDENTIFICADAS; NÃO SE LIMITE A DECLARAR QUE REVISOU. NA REVISÃO E CONSOLIDAÇÃO FINAL, APLIQUE ESSA CONFERÊNCIA TAMBÉM AOS PRODUTOS ANTERIORES, RECUPERANDO OMISSÕES QUANDO AS FONTES AUTORIZADAS AS RESOLVEREM. RELATE SEPARADAMENTE APENAS AS PENDÊNCIAS REAIS, SEM INSERIR O INVENTÁRIO INTERNO NO RESUMO.
...
ESTES VALORES SÃO OS DO PADRÃO JÁ CONSOLIDADO NOS RESUMOS ANTERIORES E NÃO PODEM SER SUBSTITUÍDOS POR OUTRO LAYOUT:

* FONTE ARIAL, TAMANHO 11, EM TODO O DOCUMENTO;
* TEXTO PRETO #000000 EM TUDO QUE NÃO FOR EMOJI;
* TÍTULO ♦️: RECUO ZERO, NEGRITO REAL, MAIÚSCULAS, SEM FAIXA;
* CABEÇALHO ▶️📚: FAIXA AZUL-CLARA #D9EAF7, RECUO ESQUERDO DE 0,15 CM, NEGRITO REAL, MAIÚSCULAS;
* LINHA DE CONTEÚDO (1️⃣, 2️⃣, 3️⃣, 🏛️, ⏱️, 🚫, ✅, ✳️, 📌): FAIXA BEGE #EEECE1, RECUO ESQUERDO DE 0,45 CM, COM O ÍCONE E O RÓTULO EM NEGRITO ATÉ OS DOIS-PONTOS E A EXPLICAÇÃO EM TEXTO NORMAL;
* PRECEDENTE JURISPRUDENCIAL (↳ STF/STJ): RECUO ESQUERDO DE 1,10 CM, TEXTO NORMAL;
* SUMÁRIO: REPETE OS TÍTULOS ♦️ EM MAIÚSCULAS, COM LINKS INTERNOS PARA AS ÂNCORAS DOS BLOCOS CORRESPONDENTES.

É PROIBIDO USAR LISTA COM MARCADOR • OU QUALQUER OUTRO BULLET NAS LINHAS DE CONTEÚDO. TODA LINHA DE CONTEÚDO SEGUE O PADRÃO ÍCONE + RÓTULO: EXPLICAÇÃO.

É PROIBIDO CRIAR RUBRICAS COM FAIXA DE OUTRA COR, COMO SALMÃO, AMARELA OU DOURADA, E É PROIBIDO APLICAR FAIXA AZUL EM LINHA QUE NÃO SEJA CABEÇALHO ▶️📚.

É PROIBIDO DEIXAR A LINHA DE CONTEÚDO INTEIRA EM NEGRITO.

É PROIBIDO SUBSTITUIR OS TÍTULOS ♦️ POR CABEÇALHOS ▶️📚: O DOCUMENTO TEM OS DOIS NÍVEIS.

NÃO INSIRA NO DOCUMENTO DESCRIÇÃO DA PRÓPRIA EXECUÇÃO — TRIAGEM, FONTES APROVADAS, ACERVO AUTORIZADO OU CRITÉRIO DE SELEÇÃO. ESSA INFORMAÇÃO, QUANDO NECESSÁRIA, VAI NA RESPOSTA DA CONVERSA, FORA DO WORD.
...
15. NÃO HÁ NENHUMA LINHA COM MARCADOR • E TODA LINHA DE CONTEÚDO SEGUE ÍCONE + RÓTULO: EXPLICAÇÃO.
16. A FONTE É ARIAL 11 EM TODO O DOCUMENTO E AS ÚNICAS FAIXAS SÃO #D9EAF7 NOS CABEÇALHOS ▶️📚 E #EEECE1 NAS LINHAS DE CONTEÚDO.
17. EXISTEM TÍTULOS ♦️ NO CORPO DO DOCUMENTO, E NÃO APENAS CABEÇALHOS ▶️📚.
18. O DOCUMENTO NÃO DESCREVE A PRÓPRIA EXECUÇÃO NEM A TRIAGEM DAS FONTES.
...
NÃO ENTREGUE APENAS O CONTEÚDO NO CHAT, SALVO PEDIDO EXPRESSO.`;
  ...
  function patchContentPrompt(prompt) {
    ...
    text = text.replaceAll("NÃO PESQUISE, ATUALIZE, CORRIJA OU COMPLETE O CONTEÚDO.",
      `NÃO ACRESCENTE CONTEÚDO EXTERNO NEM ATUALIZE POR MEMÓRIA. ${FULL_RECOVERY_RULE}`);
    ...
    text = text.replaceAll("RECUPERE INTEGRALMENTE AS INFORMAÇÕES PERTINENTES NAS FONTES AUTORIZADAS.", FULL_RECOVERY_RULE);
    // V635: desfaz a frase de 11/09 que limitava a recuperação às informações "essenciais".
    text = text.replaceAll("RECUPERE NAS FONTES AUTORIZADAS APENAS AS INFORMAÇÕES ESSENCIAIS À COMPREENSÃO DO RECORTE RESUMIDO, PRESERVANDO A SÍNTESE E A FORMATAÇÃO.", FULL_RECOVERY_RULE);
  ...
  function rememberContentBackup(targetState, type, prompt) {
    ...
    if (!String(prompt).includes(REVISION_20260911) && !String(prompt).includes(CONTENT_REVISION)) {
    ...
    if (!String(prompt).includes(CONTENT_REVISION)) {
      targetState.factoryPromptLibraryBackups[`${type}BeforeDensidadeCompletude20260921`] ??= prompt;
    }
  }
