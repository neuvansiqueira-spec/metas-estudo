...
test("nova identidade completa aparece no cabeçalho com texto alternativo", () => {
  ...
  assert.match(html, /Aldus — Conhecimento, Meta e Sabedoria/);
...
test("V89 renova cache e mantém raiz e publicação em paridade", () => {
  ...
  assert.match(read("service-worker.js"), /"20260720-espaco-mensagem-cronometro-v88"/);
