...
test('arquivos carregados usam a versão atual', () => {
  assert.match(html, /style\.css\?v=20260717-vinculos-materiais-v22/);
  assert.match(html, /storage-indexeddb\.js\?v=20260717-vinculos-materiais-v22/);
  assert.match(html, /script\.js\?v=20260717-vinculos-materiais-v22/);
  assert.match(html, /Versão: 20260717-vinculos-materiais-v22/);
});
...
test('service worker prioriza rede para app shell versionado', () => {
  const sw = fs.readFileSync('service-worker.js', 'utf8');
  assert.match(sw, /metas-estudo-20260717-vinculos-materiais-v22/);
