...
test('arquivos carregados usam a versão atual', () => {
  assert.match(html, /style\.css\?v=20260714-recuperacao-tempo-antigo-cronometro-v2/);
  assert.match(html, /storage-indexeddb\.js\?v=20260714-recuperacao-tempo-antigo-cronometro-v2/);
  assert.match(html, /script\.js\?v=20260714-recuperacao-tempo-antigo-cronometro-v2/);
  assert.match(html, /Versão: 20260714-recuperacao-tempo-antigo-cronometro-v2/);
});
...
test('service worker prioriza rede para app shell versionado', () => {
  ...
  assert.match(sw, /metas-estudo-20260714-recuperacao-tempo-antigo-cronometro-v2/);
