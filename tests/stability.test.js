...
test('arquivos carregados usam a versão atual', () => {
  assert.match(html, /style\.css\?v=20260713-corrige-duplicidade-materiais/);
  assert.match(html, /script\.js\?v=20260713-corrige-duplicidade-materiais/);
  assert.match(html, /Versão: 20260713-corrige-duplicidade-materiais/);
});
...
test('service worker prioriza rede para app shell versionado', () => {
  ...
  assert.match(sw, /metas-estudo-20260713-corrige-duplicidade-materiais/);
