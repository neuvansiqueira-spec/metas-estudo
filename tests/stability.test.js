...
test('arquivos carregados usam a versão do banco de questões', () => {
  assert.match(html, /style\.css\?v=20260701-error-notebook/);
  assert.match(html, /script\.js\?v=20260701-error-notebook/);
  assert.match(html, /Versão: 20260701-error-notebook/);
});
...
test('service worker prioriza rede para app shell versionado', () => {
  ...
  assert.match(sw, /metas-estudo-cache-20260701-error-notebook/);
