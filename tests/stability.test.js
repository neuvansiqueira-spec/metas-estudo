...
test('arquivos carregados usam a versão atual', () => {
  assert.match(html, /style\.css\?v=20260712-materiais-detalhes-recolhiveis/);
  assert.match(html, /script\.js\?v=20260712-materiais-detalhes-recolhiveis/);
  assert.match(html, /Versão: 20260712-materiais-detalhes-recolhiveis/);
});
...
test('service worker prioriza rede para app shell versionado', () => {
  ...
  assert.match(sw, /metas-estudo-20260712-materiais-detalhes-recolhiveis/);
