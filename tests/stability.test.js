...
test('arquivos carregados usam a versão atual', () => {
  assert.match(html, /style\.css\?v=20260714-planejamento-acordeao-modos-dia-v1/);
  assert.match(html, /storage-indexeddb\.js\?v=20260714-planejamento-acordeao-modos-dia-v1/);
  assert.match(html, /script\.js\?v=20260714-planejamento-acordeao-modos-dia-v1/);
  assert.match(html, /Versão: 20260714-planejamento-acordeao-modos-dia-v1/);
});
...
test('service worker prioriza rede para app shell versionado', () => {
  ...
  assert.match(sw, /metas-estudo-20260714-planejamento-acordeao-modos-dia-v1/);
