...
test("V367 está espelhada e ligada aos dois caminhos de bootstrap publicados", () => {
  ...
  for (const file of ["bootstrap-fast-path-v351.js", "bootstrap-integrity-loader-v258-core.js"]) {
    ...
    assert.match(rootSource, /aldusPlanningQualityV367.*planning-quality-v367\.js\?v=20260821-planning-quality-v367/);
