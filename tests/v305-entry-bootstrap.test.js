...
assert.match(indexSource, /aldus-entry-bootstrap-v307/, "a entrada deve identificar a entrega autoritativa do diagnóstico V307");
assert.match(indexSource, /20260811-duplicate-core-delivery-v307/, "a entrada deve renovar o núcleo do diagnóstico sem perder a recuperação V306");
...
assert.doesNotThrow(() => new vm.Script(inlineScript), "o bootstrap V307 deve preservar a recuperação sintática V306");
...
assert.match(workerSource, /duplicate-core-delivery-v307/, "o cache deve ser renovado para a entrega correta do diagnóstico");
...
console.log("v307 duplicate core delivery: covered");
