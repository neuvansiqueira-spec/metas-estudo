(() => {
  ...
  const VERSION = "20260731-remove-agulha-menu-lateral-v206";
  ...
  const MODULE_CLASS = "side-nav-hover-v206";
  const STYLE_ID = "sideNavHoverV206Style";
  ...
  function applyDesktopState() {
    ...
    if (!isDesktop()) {
      ...
      nav.classList.remove("side-nav-hover-enabled-v206");
    ...
    nav.classList.add("side-nav-hover-enabled-v206");
  ...
  function bindEvents() {
    if (!nav || nav.dataset.sideNavHoverBoundV206 === "true") return;
    nav.dataset.sideNavHoverBoundV206 = "true";
  ...
  globalThis.AldusSideNavHoverV206 = Object.freeze({
    version: VERSION,
