...
const FACTORY_SIMULADO_SCRIPT = "factory-simulado-prompt-v310.js?v=20260811-gerador-simulados-disciplinas-v311";
const FACTORY_SIMULADO_STYLESHEET = "factory-simulado-prompt-v310.css?v=20260811-gerador-simulados-disciplinas-v311";
const STATIC_ASSETS = [
  "./",
  "index.html",
...
const ESSENTIAL_ASSETS = ["./", "index.html", `app-${RELEASE_SUFFIX}.css?v=${CURRENT_VERSION}`, `app-${RELEASE_SUFFIX}.js?v=${CURRENT_VERSION}`, QUESTIONS_HUB_STYLESHEET, QUESTIONS_HUB_SCRIPT, QUESTION_JSON_DETAILS_SCRIPT, FACTORY_SIMULADO_SCRIPT, FACTORY_SIMULADO_STYLESHEET, DUPLICATE_RECOMMENDATIONS_CORE, DUPLICATE_DIAGNOSTICS_CORE_CSS, DUPLICATE_BATCH_HOTFIX, SECURITY_HARDENING, CATASTROPHIC_STATE_GUARD, BOOTSTRAP_PROTECTED, BOOTSTRAP_CORE];
