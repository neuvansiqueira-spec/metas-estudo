...
const CACHE_NAME = `metas-estudo-${CURRENT_VERSION}-factory-weekly-dedupe-v237-hotfix1`;
...
const FACTORY_QUEUE_INTEGRITY = `factory-queue-integrity-v236.js?v=${CURRENT_VERSION}&hotfix=factory-queue-integrity-hotfix4`;
...
async function ensurePageStylesheets(response) {
  ...
  headers.set("x-aldus-factory-queue-hotfix", "factory-queue-integrity-hotfix4");
