(() => {
  ...
  // V610 - limita somente as automaticas; peca e cotas manuais sao adicionais.
  function installDailyPlanQuotaV610() {
    if (typeof document === "undefined") return;
    if (document.getElementById("aldusDailyPlanQuotaV610")) return;
    const script = document.createElement("script");
    script.id = "aldusDailyPlanQuotaV610";
    script.src = "daily-plan-quota-v610.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  // V427 - estabilidade do Plano do Dia e preenchimento aditivo.
  ...
  function installDailyPlanPendingPanelV429() {
    ...
    script.src = "daily-plan-pending-panel-v429.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  function installDailyNetHoursCardV433() {
    ...
    script.src = "daily-net-hours-card-v433.js?v=20260912-tempo-segundos-indicadores-v424";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  function installDailyPlanQuestionImportV451() {
    ...
    script.src = "daily-plan-question-import-v451.js?v=20260913-treino-questoes-lateral-v424";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  function installDailyPlanLegibilityV455() {
    ...
    script.src = "daily-plan-legibility-v455.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  function installDailyPlanPreviewV462() {
    ...
    script.src = "daily-plan-preview-v462.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
  ...
  function installTimerPictureInPictureV458() {
    ...
    script.src = "timer-picture-in-picture-v458.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  function installQuestionPreviewAnswerV614() {
    ...
    script.src = "question-preview-answer-v614.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
    script.addEventListener("error", () => {
  ...
  function installGoalCalendarExportV623() {
    ...
    script.src = "goal-calendar-export-v623.js?v=20260916-calendario-real-pdf-leve-v623-5";
    script.async = false;
    script.addEventListener("error", () => {
