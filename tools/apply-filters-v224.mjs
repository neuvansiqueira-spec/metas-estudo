...
const RUNTIME_FILE = "question-bank-filters-v224.js";
...
function updateBuildSources() {
  ...
  source = replaceRequired(
    ...
    "marcador obrigatório dos filtros v224"
  );
  ...
  source = replaceRequired(
    ...
    "cópia dos filtros v224 para docs"
  );
...
updateVersions();
updateBuildSources();
console.log(`Versão ${VERSION} preparada com filtros completos do treino.`);
