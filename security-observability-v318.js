(() => {
  ...
  function installEmergencyPerformanceV350() {
    ...
    script.src = "performance-emergency-v350.js?v=20260913-cota-sem-repeticao-v618";
    script.async = false;
  ...
  function installFactorySimuladoDiscursivoV619() {
    ...
    script.src = "factory-simulado-discursivo-v619.js?v=20260913-simulado-discursivo-delegado-v620";
    script.async = false;
    script.addEventListener("error", () => {
