(() => {
  if (window.__aldusCalendarMonthVisibilityV129) return;
  window.__aldusCalendarMonthVisibilityV129 = true;

  const styleId = "aldusCalendarMonthVisibilityV129";
  ...
  style.textContent = `
    ...
    html[data-aldus-theme="premium-stable"] #view-calendario-metas .month-grid > article.clickable-day {
      ...
      background:
        radial-gradient(circle at 88% 12%, rgba(66, 153, 225, .14), transparent 42%),
    ...
    html[data-aldus-theme="premium-stable"] #view-calendario-metas .month-grid > article.clickable-day > small {
      ...
      overflow: hidden !important;
      border: 1px solid rgba(116, 177, 238, .28) !important;
    ...
    html[data-aldus-theme="premium-stable"] #view-calendario-metas .month-grid > article.clickable-day > span {
      ...
      border: 1px solid rgba(103, 165, 229, .24) !important;
    ...
    html[data-aldus-theme="premium-stable"] #view-calendario-metas .month-grid > article.clickable-day > span:nth-of-type(2) {
      ...
      border-color: rgba(70, 210, 167, .24) !important;
      background: rgba(13, 82, 67, .24) !important;
