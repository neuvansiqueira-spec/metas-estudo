...
const DUPLICATE_RECOMMENDATIONS_VERSION = "20260810-duplicate-recommendations-v303";
...
const DUPLICATE_RECOMMENDATIONS_CORE = `duplicate-diagnostics-v303.js?v=${DUPLICATE_RECOMMENDATIONS_VERSION}`;
const DUPLICATE_BATCH_HOTFIX = `duplicate-diagnostics-batch-v303.js?v=${DUPLICATE_BATCH_HOTFIX_VERSION}`;
...
async function ensurePageStylesheets(response) {
  ...
  headers.set("x-aldus-duplicate-search", "duplicate-recommendations-v303");
