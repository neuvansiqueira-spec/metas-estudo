...
const DUPLICATE_BATCH_HOTFIX_VERSION = "20260810-duplicate-batch-authoritative-v302";
...
const DUPLICATE_BATCH_HOTFIX = `duplicate-diagnostics-batch-v302.js?v=${DUPLICATE_BATCH_HOTFIX_VERSION}`;
...
const ESSENTIAL_ASSETS = ["./", "index.html", `app-${RELEASE_SUFFIX}.css?v=${CURRENT_VERSION}`, `app-${RELEASE_SUFFIX}.js?v=${CURRENT_VERSION}`, QUESTIONS_HUB_STYLESHEET, QUESTIONS_HUB_SCRIPT, QUESTION_JSON_DETAILS_SCRIPT, DUPLICATE_BATCH_HOTFIX, SECURITY_HARDENING, CATASTROPHIC_STATE_GUARD, BOOTSTRAP_PROTECTED, BOOTSTRAP_CORE];
...
async function ensurePageStylesheets(response) {
  ...
  headers.set("x-aldus-duplicate-search", "duplicate-batch-authoritative-v302");
