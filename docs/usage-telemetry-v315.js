(() => {
  ...
  if (globalThis.__aldusUsageTelemetryV316) return;

  const VERSION = "20260812-usage-telemetry-security-v316";
  const STORAGE_KEY = "aldus:usage:local:v316";
  const SESSION_KEY = "aldus:usage:session:v316";
